...
CODING_PROMPT = (
    ...
    "WICHTIG: Du arbeitest AUSSCHLIESSLICH innerhalb des Workspace-Ordners. Alle "
    "Datei-Tools sind technisch auf diesen Ordner begrenzt, Zugriffe ausserhalb werden "
    "blockiert, und Shell-Befehle starten immer im Workspace. Versuche gar nicht erst, "
    "ausserhalb zu lesen oder zu schreiben. "
