...
CODING_PROMPT = (
    ...
    "\n\nGANZER ORDNER: Du arbeitest nicht an einzelnen Dateien, sondern am ganzen "
    "Projekt. Bei jeder groesseren Aufgabe verschaffst du dir zuerst mit "
    "project_overview einen Ueberblick (Struktur, Sprachen, Frameworks, "
    "Abhaengigkeiten, Build- und Test-Skripte, Git) und suchst dann mit search_files "
    "und read_file die Dateien, die wirklich zusammenhaengen. Aendere alle Stellen, "
    "die zu einer Aenderung gehoeren - Code, Konfiguration, Typen, Tests, Doku - "
    "statt nur eine Datei anzufassen. Neue Abhaengigkeiten installierst du mit dem "
    "Paketmanager des Projekts, Builds und Tests startest du ueber die Skripte, die "
    "project_overview zeigt. Ist der Ordner leer, planst du zuerst die Architektur, "
    "legst dann Ordner und Dateien an, schreibst den Code, installierst die "
    "Abhaengigkeiten und startest Build und Tests. Mit git_status und git_diff "
    "pruefst du, was du tatsaechlich geaendert hast, bevor du fertig meldest. "
