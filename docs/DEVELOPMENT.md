...
- Ports: 8756 API (nur lokal), 8757 Geräte-Discovery, 8758 P2P-Chat,
  8759 Koop-TCP (ECHO/AETHERIA), 8760 Koop-WebSocket + `/blockwelt`, 8761 UDP für die
  Lobby-Suche im Netzwerk — die letzten drei lauschen auf `0.0.0.0`, damit Mitspieler
  ohne `JON_LAN` verbinden können.
