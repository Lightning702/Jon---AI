...
export const en: Translations = {
  ...
  br_dryrun: "Dry run",
  br_ready: "ready",
  br_planning: "planning",
  br_working: "working",
  br_waiting: "waiting for you",
  br_done: "done",
  br_error: "error",
  br_actions: "{n} actions",
  br_risk: "risk {level}",
  br_refresh: "refresh",
  br_confirm_needed: "Confirmation required",
  br_confirm: "Confirm",
  br_cancel: "Cancel",
  br_released: "Approved. Tell Jon to continue.",
  br_denied: "Declined. Jon will not perform the action.",
  br_close_browser: "Close browser",
  ap_title: "Jon wants to run something",
  ap_allow: "Allow",
  ap_deny: "Deny",
  ap_details_show: "Show details",
  ap_details_hide: "Hide details",
  ap_risk_low: "harmless",
  ap_risk_mid: "changes something",
  ap_risk_high: "hard to undo",
};
