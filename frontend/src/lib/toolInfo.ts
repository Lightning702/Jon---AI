export const TOOL_LABELS: Record<string, string> = {
  ...
  start_timer: "Timer stellen",
  start_stopwatch: "Stoppuhr starten",
  set_alarm: "Wecker stellen",
  stop_timer: "Uhr stoppen",
  list_timers: "Uhren zeigen",
  list_alarms: "Wecker zeigen",
  delete_alarm: "Wecker löschen",
  adjust_timer: "Zeit ändern",
  control_timer: "Uhr steuern",
  ...
  browser_goto: "Seite öffnen",
  browser_search: "Im Web suchen",
  browser_read: "Seite lesen",
  browser_click: "Klicken",
  browser_fill: "Feld ausfüllen",
  browser_press: "Taste drücken",
  browser_scroll: "Scrollen",
  browser_select: "Auswählen",
  browser_back: "Zurück",
  browser_forward: "Vorwärts",
  browser_reload: "Neu laden",
  browser_tab_new: "Neuer Tab",
  browser_tab_switch: "Tab wechseln",
